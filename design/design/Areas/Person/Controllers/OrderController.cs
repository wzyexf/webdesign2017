...
namespace design.Areas.Person.Controllers
{
    public class OrderController : Controller
    {
        ...
        {
            int BuyerId = 1;
            var t_Shop_Order = db.T_Shop_Order.Include(t => t.T_Shop_Buyer).Where(m=>m.BuyerId==BuyerId);
            return View(t_Shop_Order.ToList());
        }

        // GET: Person/Order/Details/5
